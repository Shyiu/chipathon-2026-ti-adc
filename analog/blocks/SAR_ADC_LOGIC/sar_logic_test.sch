...
N -1020 -120 -1020 -80 {lab=0}
N -960 -220 -960 -185 {lab=INP}
N -960 -120 -960 -80 {lab=0}
N -900 -220 -900 -180 {lab=INN}
N -900 -120 -900 -80 {lab=0}
N -960 -185 -960 -180 {lab=INP}
N -845 -220 -845 -180 {lab=nCLK}
N -845 -120 -845 -80 {lab=0}
N -845 100 -845 140 {lab=0}
N -845 0 -845 40 {lab=CLK}
N -1020 -220 -1020 -180 {lab=VDD}
N 90 30 90 70 {lab=VDD}
C {lab_pin.sym} 230 -240 1 0 {name=p17 sig_type=std_logic lab=VDD}
C {gnd.sym} 230 190 0 0 {name=l7 lab=0}
C {code_shown.sym} -350 -520 0 0 {name=MODELS only_toplevel=true
...
.ends
"}
C {vsource.sym} -1020 -150 0 0 {name=V3 
value=3.3
savecurrent=false}
C {vsource.sym} -960 -150 0 0 {name=V4 
value="sin(2 1 25MEG)"
savecurrent=false}
C {vsource.sym} -900 -150 0 0 {name=V6 
value="sin(2 1 25MEG 5n)"
savecurrent=false}
C {lab_pin.sym} -960 -220 1 0 {name=p4 sig_type=std_logic lab=INP}
C {lab_pin.sym} -900 -220 1 0 {name=p5 sig_type=std_logic lab=INN}
C {gnd.sym} -1020 -80 0 0 {name=l3 lab=0}
C {gnd.sym} -960 -80 0 0 {name=l5 lab=0}
C {gnd.sym} -900 -80 0 0 {name=l6 lab=0}
C {vsource.sym} -845 -150 0 0 {name=V7 
value= "PULSE(0 3.3 0 50p 50p 2.5n 5n)"
savecurrent=false}
C {lab_pin.sym} -845 0 1 0 {name=p28 sig_type=std_logic lab=CLK}
C {gnd.sym} -845 -80 0 0 {name=l8 lab=0}
C {vsource.sym} -845 70 0 0 {name=V8 
value= "PULSE(0 3.3 2.5n 50p 50p 10n 20n)"
savecurrent=false}
C {gnd.sym} -845 140 0 0 {name=l9 lab=0}
C {lab_pin.sym} -845 -220 1 0 {name=p29 sig_type=std_logic lab=nCLK}
C {lab_pin.sym} -1020 -220 1 0 {name=p30 sig_type=std_logic lab=VDD}
C {code_shown.sym} -1040 -530 0 0 {name=s3 only_toplevel=true 
value="
.control
tran 10n 100n
...
C {proj_branch/chipathon-2026-ti-adc/analog/blocks/SAR_ADC_LOGIC/sar_logic.sym} 220 -30 0 0 {name=X1 model=sar_adc_logic}
